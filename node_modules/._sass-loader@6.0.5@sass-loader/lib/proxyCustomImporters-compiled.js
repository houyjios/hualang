...
function proxyCustomImporters(importer, resourcePath) {
    return [].concat(importer).map(function (importer) {
        return function (url, prev, done) {
            return importer.apply(this, // eslint-disable-line no-invalid-this
            Array.from(arguments).map(function (arg, i) {
                return i === 1 && arg === "stdin" ? resourcePath : arg;
            }));
        };
    });
}
...
//# sourceMappingURL=proxyCustomImporters-compiled.js.map