...
function importsToResolve(request) {
    ...
    var isModuleImport = request.charAt(0) !== "." && dirname === ".";
    ...
    map(function (ext) {
        return "_" + basename + ext;
    }).concat(extPrecedence.map(function (ext) {
        return basename + ext;
    })).map(function (file) {
        return dirname + "/" + file;
...
//# sourceMappingURL=importsToResolve-compiled.js.map